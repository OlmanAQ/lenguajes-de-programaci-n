public class Main {
    public static void main(String[] args) {
        ...
        //agendaPersonal.modificarContacto("pablo",new Contacto(new Persona("pablo",21,false),"a lado al parque","2456354643"));
        System.out.println("***IMPRIMIENDO CONTACTOS***");
        agendaPersonal.imprimirContactos();


        agendaPersonal.agregarEvento(new EventoT1("escuela", "2/10/2022", "15:30", "Cumpleaños de la escuela"));
        agendaPersonal.agregarEvento(new EventoT1("casa", "2/10/2022", "15:30", "Cumpleaños de la casa"));
